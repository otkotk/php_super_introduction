...
foreach($pdo -> query("select * from product") as $row){
    ...
    echo '<div class="td0" style="float:left; margin-left:20px;">';
    echo $row["id"];
    echo '</div>';
    echo '<div class="td1" style="float:left; margin-left:20px;">';
    echo '</div>';
    echo '<div class="td1" style="float:left; margin-left:20px;">';
    ...
    echo '</div>';
    echo '<div class="td2" style="float:left; margin-left:20px;">';
