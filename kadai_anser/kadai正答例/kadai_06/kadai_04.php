...
<section id="kadai_04_que">
<h2>「課題４」 簡単な足し算クイズ（入力画面）</h2>
<form action="kadai_04_output.php"" method="post">
<h3>問題</h3>
<p><input type="text" name="num1" value="5" required> ＋ <input type="text" name="num2" value="3" required> ＝ <input type="text" name="userAns" required> </p>
